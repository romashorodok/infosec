<script lang="ts">
	...
	const schema = yup.object({
		...
		password: yup
			...
			.matches(
				/[a-zA-Z]/,
				"Password can contain only Latin latter's"
			)
...
<div class="flex h-full">
	<div
		class="m-auto w-2/4 h-3/5 theme-bg-base theme-fg-base theme-shadow-base"
	>
		<div class="flex flex-col h-full w-full px-8 py-9">
			...
			>
				...
				<Input label="Password" {...fields.password} inputType={"password"} />
